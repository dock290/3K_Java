package psuti.kirgizov.service;
...
public class PhoneService {
    ...
    public static List<Phone> service(HttpServletRequest request) {
        try {
        ...
        try {
            if (Objects.nonNull(request.getParameter("findByNumber"))) {
                ...
                for (String number : checkboxes) {
                    database.remove(Integer.parseInt(number));
                }
