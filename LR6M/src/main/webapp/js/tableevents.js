...
function tableAddNewRow() {
    ...
    tableCell.id = 7;
    tableCell.setAttribute("class", "table-cell");
    tableCell.innerHTML = `<input form="sidebar-form-save" class="table-checkbox" name="checkbox" type="checkbox" value="${document.getElementById("table-cell-input-number").value}">`;
